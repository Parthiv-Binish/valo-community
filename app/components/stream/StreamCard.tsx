...
export default function StreamerCard({ streamer }: StreamerCardProps) {
  const cfg = PLATFORM_CONFIG[streamer.platform as keyof typeof PLATFORM_CONFIG] || PLATFORM_CONFIG.youtube
        ...
        {streamer.isLive && streamer.thumbnail ? (
          <>
            <img
              ...
              loading="lazy"
              onError={(e) => {
                (e.target as HTMLImageElement).src = 'https://placehold.co/640x360/181818/ff4655?text=LIVE'
              }}
            />
